...
class Ui_MainWindow(object):
    ...
    def load_song(self):
        ...
        for basic_song in basic_song_name:
            if basic_song not in songs.basic_music_list:
                songs.basic_music_list.append(str(basic_song))
        self.free_song_list.clear()
        for basic_song_str in songs.basic_music_list:
        ...
        for link_value in links:
            songs.current_songs_list.append(link_value)
    ...
    def default_next(self):
        try:
            ...
            if current_selection + 1 == len(songs.current_songs_list):
                next_index = 0
            else:
...
"}\n"
"\n"
"#free_song_list, #music_pack_1, #music_pack_2, #music_pack_3, #search_list{\n"
"background-color: #1f1f1f;\n"
...
"}")
        ...
        self.label_4 = QtWidgets.QLabel(self.music_list)
        font = QtGui.QFont()
        font.setFamily("Arial Rounded MT Bold")
        font.setPointSize(15)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("resources3.qrc/back.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("resources3.qrc/pause.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("resources3.qrc/play.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("resources3.qrc/stop.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("resources3.qrc/next.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("resources3.qrc/plus.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("resources3.qrc/volume_white.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Basic pack"))
        ...
        self.download_btn.clicked.connect(self.downloadDisable)
        self.download_btn_2.clicked.connect(self.downloadDisable)
        ...
        self.next_btn.clicked.connect(self.default_next)
